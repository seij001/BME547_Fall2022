...
@pytest.mark.parametrize("input_HDL, expected",
                         [(85, "Normal"),  # These are test cases, in tuples
                          (50, "Borderline Low"),
                          (30, "Low")])
# argument needs to be the string version of the exact parameters of function
def test_check_HDL(input_HDL, expected):
    from blood_calculator import check_HDL
    answer = check_HDL(input_HDL)  # variable name doesn't need to be answer
